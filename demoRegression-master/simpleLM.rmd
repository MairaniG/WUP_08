...
For model length~HEADLEN, adjusted $r^2$ =0.8434  , this is a little bit better than the adjusted $r^2$ for chest so this model is slightly better than the chest model.  
...
For model length~WEIGHT, the adjusted $r^2$ =0.7423, this is better than the adjusted $r^2$ for HEADWTH so this model is better than the chest model. 
